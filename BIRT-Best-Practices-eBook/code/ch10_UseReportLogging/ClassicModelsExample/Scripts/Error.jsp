<%-----------------------------------------------------------------------------
	...
	****************************************************
	* Le BIRT Expert
	* Modified to show generic error message
	* Refer to Chapter 16 of Le BIRT Expert's Guide
	* to BIRT Best Practices for more information
	****************************************************
-----------------------------------------------------------------------------%>
...
<HTML>
	...
	<BODY>
		<TABLE CLASS="BirtViewer_Highlight_Label">
			<TR><TD NOWRAP>
				An error has occurred.  Please contact IT Help.
				<%
					/**
					if ( error != null )
					{
